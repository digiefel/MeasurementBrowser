...
5. [plotting-api-design.md](plotting-api-design.md) — figure composition and workflow persistence
   above the public plot callback contract.
6. [spatial-browser.md](spatial-browser.md) — spatial navigation, device layout, tags, and notes.
